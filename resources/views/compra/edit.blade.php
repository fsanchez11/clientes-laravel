	...
	<div class="box box-primary">
		<div class="box-body">
			...
			@include('partials.messages')		
				...
				{!! Form::model($compraas, ['route' => ['compra.update', $compraas->id], 'method' =>'PUT']) !!}
					...
					{!! Form::text('date_compra', null, ['class' =>'form-control']) !!}
					</div>

					<div class="form-group col-sm-6">
					{!! Form::label('date_render', 'Fecha de Devolucion') !!}
					{!! Form::text('date_render', null, ['class' =>'form-control']) !!}
					</div>
